...
public class ResourceProxy extends AbstractResourcePack {
    ...
    private static final Set<String> RESOURCE_DOMAINS = ImmutableSet.of(MINECRAFT, Embers.MODID, Soot.MODID);
    ...
    public void addResource(String space, String modid, String dir, String file, String ext) {
        ...
        String override = String.format(OVERRIDE_FORMAT, Soot.MODID, space, dir, file, ext);
    ...
    protected InputStream getInputStreamByName(String name) throws IOException {
        ...
        InputStream stream = Soot.class.getResourceAsStream(overrides.get(name));
