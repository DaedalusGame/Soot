...
public class TileEntityEmberBoreImprovedRenderer extends TileEntitySpecialRenderer<TileEntityEmberBoreImproved> {
    ...
    public TileEntityEmberBoreImprovedRenderer(){
        super();
    }

    @Override
    public void render(TileEntityEmberBoreImproved tile, double x, double y, double z, float partialTicks, int destroyStage, float tileAlpha){
        if (tile != null){
            ...
            float pTicksRotation = partialTicks*(tile.angle - tile.lastAngle);
