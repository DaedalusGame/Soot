...
public class TileEntityAlchemyTabletImprovedRenderer extends TileEntitySpecialRenderer<TileEntityAlchemyTabletImproved> {
    public ResourceLocation texture = new ResourceLocation(Embers.MODID + ":textures/entity/beam.png");

    @Override
    public void render(TileEntityAlchemyTabletImproved tile, double x, double y, double z, float partialTicks, int destroyStage, float tileAlpha){
        if (tile != null){
            if (tile.process != 0){
