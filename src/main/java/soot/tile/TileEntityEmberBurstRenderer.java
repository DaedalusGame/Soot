...
public class TileEntityEmberBurstRenderer extends TileEntitySpecialRenderer {
    ...
    public TileEntityEmberBurstRenderer(){
        super();
    }

    @Override
    public void render(TileEntity tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha){
        if (tile instanceof TileEntityEmberBurst){
            TileEntityEmberBurst pipe = (TileEntityEmberBurst)tile;
            ...
            if (pipe.south == TileEntityEmberBurst.EnumConnection.LEVER){
